...
PROTOBUF_NAMESPACE_OPEN
template <>
::operations_research::packing::MultipleDimensionsBinPackingItem* Arena::CreateMaybeMessage<::operations_research::packing::MultipleDimensionsBinPackingItem>(Arena*);
template <>
::operations_research::packing::MultipleDimensionsBinPackingProblem* Arena::CreateMaybeMessage<::operations_research::packing::MultipleDimensionsBinPackingProblem>(Arena*);
template <>
::operations_research::packing::MultipleDimensionsBinPackingShape* Arena::CreateMaybeMessage<::operations_research::packing::MultipleDimensionsBinPackingShape>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class MultipleDimensionsBinPackingShape final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int64_t>& dimensions() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int64_t>* mutable_dimensions();

  private:
  ::int64_t _internal_dimensions(int index) const;
  void _internal_add_dimensions(::int64_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int64_t>& _internal_dimensions() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int64_t>* _internal_mutable_dimensions();
 ...
 private:
  ...
  struct Impl_ {
    ...
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _dimensions_cached_byte_size_;
...
class MultipleDimensionsBinPackingItem final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::operations_research::packing::MultipleDimensionsBinPackingShape>& _internal_shapes() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::operations_research::packing::MultipleDimensionsBinPackingShape>* _internal_mutable_shapes();
  public:
...
class MultipleDimensionsBinPackingProblem final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::operations_research::packing::MultipleDimensionsBinPackingItem>& _internal_items() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::operations_research::packing::MultipleDimensionsBinPackingItem>* _internal_mutable_items();
  public:
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int64_t>& MultipleDimensionsBinPackingShape::dimensions() const {
  // @@protoc_insertion_point(field_list:operations_research.packing.MultipleDimensionsBinPackingShape.dimensions)
  return _internal_dimensions();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int64_t>* MultipleDimensionsBinPackingShape::mutable_dimensions() {
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int64_t>& MultipleDimensionsBinPackingShape::_internal_dimensions() const {
  return _impl_.dimensions_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int64_t>* MultipleDimensionsBinPackingShape::_internal_mutable_dimensions() {
  return &_impl_.dimensions_;
}
...
inline ::operations_research::packing::MultipleDimensionsBinPackingShape* MultipleDimensionsBinPackingItem::_internal_add_shapes() {
  return _internal_mutable_shapes()->Add();
}

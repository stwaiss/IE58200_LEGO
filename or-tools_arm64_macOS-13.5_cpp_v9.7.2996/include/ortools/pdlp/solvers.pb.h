...
PROTOBUF_NAMESPACE_OPEN
template <>
::operations_research::pdlp::AdaptiveLinesearchParams* Arena::CreateMaybeMessage<::operations_research::pdlp::AdaptiveLinesearchParams>(Arena*);
template <>
::operations_research::pdlp::MalitskyPockParams* Arena::CreateMaybeMessage<::operations_research::pdlp::MalitskyPockParams>(Arena*);
template <>
::operations_research::pdlp::PrimalDualHybridGradientParams* Arena::CreateMaybeMessage<::operations_research::pdlp::PrimalDualHybridGradientParams>(Arena*);
template <>
::operations_research::pdlp::PrimalDualHybridGradientParams_PresolveOptions* Arena::CreateMaybeMessage<::operations_research::pdlp::PrimalDualHybridGradientParams_PresolveOptions>(Arena*);
template <>
::operations_research::pdlp::TerminationCriteria* Arena::CreateMaybeMessage<::operations_research::pdlp::TerminationCriteria>(Arena*);
template <>
::operations_research::pdlp::TerminationCriteria_DetailedOptimalityCriteria* Arena::CreateMaybeMessage<::operations_research::pdlp::TerminationCriteria_DetailedOptimalityCriteria>(Arena*);
template <>
::operations_research::pdlp::TerminationCriteria_SimpleOptimalityCriteria* Arena::CreateMaybeMessage<::operations_research::pdlp::TerminationCriteria_SimpleOptimalityCriteria>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
inline const std::string& PrimalDualHybridGradientParams_RestartStrategy_Name(PrimalDualHybridGradientParams_RestartStrategy value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<PrimalDualHybridGradientParams_RestartStrategy_descriptor,
                                                 0, 4>(
...
inline const std::string& PrimalDualHybridGradientParams_LinesearchRule_Name(PrimalDualHybridGradientParams_LinesearchRule value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<PrimalDualHybridGradientParams_LinesearchRule_descriptor,
                                                 0, 3>(
      static_cast<int>(value));
}
...
inline const std::string& OptimalityNorm_Name(OptimalityNorm value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<OptimalityNorm_descriptor,
                                                 0, 3>(
      static_cast<int>(value));
}
...
class PrimalDualHybridGradientParams final :
 ...
 public:
  ...
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* RestartStrategy_descriptor() {
  ...
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* LinesearchRule_descriptor() {
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int32_t>& random_projection_seeds() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int32_t>* mutable_random_projection_seeds();

  private:
  ::int32_t _internal_random_projection_seeds(int index) const;
  void _internal_add_random_projection_seeds(::int32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int32_t>& _internal_random_projection_seeds() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int32_t>* _internal_mutable_random_projection_seeds();
 ...
 private:
  ...
  struct Impl_ {
    ...
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _random_projection_seeds_cached_byte_size_;
...
inline void PrimalDualHybridGradientParams::clear_random_projection_seeds() {
  _internal_mutable_random_projection_seeds()->Clear();
}
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int32_t>& PrimalDualHybridGradientParams::random_projection_seeds() const {
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int32_t>* PrimalDualHybridGradientParams::mutable_random_projection_seeds() {
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int32_t>& PrimalDualHybridGradientParams::_internal_random_projection_seeds() const {
  return _impl_.random_projection_seeds_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int32_t>* PrimalDualHybridGradientParams::_internal_mutable_random_projection_seeds() {
  return &_impl_.random_projection_seeds_;
}

...
PROTOBUF_NAMESPACE_OPEN
template <>
::operations_research::bop::BopOptimizerMethod* Arena::CreateMaybeMessage<::operations_research::bop::BopOptimizerMethod>(Arena*);
template <>
...
inline const std::string& BopOptimizerMethod_OptimizerType_Name(BopOptimizerMethod_OptimizerType value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<BopOptimizerMethod_OptimizerType_descriptor,
                                                 0, 17>(
...
inline const std::string& BopParameters_ThreadSynchronizationType_Name(BopParameters_ThreadSynchronizationType value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<BopParameters_ThreadSynchronizationType_descriptor,
                                                 0, 2>(
      static_cast<int>(value));
}
...
class BopOptimizerMethod final :
 ...
 public:
  ...
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* OptimizerType_descriptor() {
...
class BopSolverOptimizerSet final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::operations_research::bop::BopOptimizerMethod>& _internal_methods() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::operations_research::bop::BopOptimizerMethod>* _internal_mutable_methods();
  public:
...
class BopParameters final :
 ...
 public:
  ...
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* ThreadSynchronizationType_descriptor() {
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::operations_research::bop::BopSolverOptimizerSet>& _internal_solver_optimizer_sets() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::operations_research::bop::BopSolverOptimizerSet>* _internal_mutable_solver_optimizer_sets();
  public:
  ...
  void set_allocated_default_solver_optimizer_sets(std::string* ptr);
...
inline void BopParameters::clear_solver_optimizer_sets() {
  _internal_mutable_solver_optimizer_sets()->Clear();
}
...
inline ::operations_research::bop::BopSolverOptimizerSet* BopParameters::_internal_add_solver_optimizer_sets() {
  return _internal_mutable_solver_optimizer_sets()->Add();
}
...
inline PROTOBUF_ALWAYS_INLINE void BopParameters::set_default_solver_optimizer_sets(Arg_&& arg,
                                                     Args_... args) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.default_solver_optimizer_sets_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void BopParameters::set_allocated_default_solver_optimizer_sets(std::string* value) {
  ...
  _impl_.default_solver_optimizer_sets_.SetAllocated(value, GetArenaForAllocation());

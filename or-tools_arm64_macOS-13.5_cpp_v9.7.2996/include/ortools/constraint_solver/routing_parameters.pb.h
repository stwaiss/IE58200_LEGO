...
PROTOBUF_NAMESPACE_OPEN
template <>
::operations_research::RoutingModelParameters* Arena::CreateMaybeMessage<::operations_research::RoutingModelParameters>(Arena*);
template <>
...
inline const std::string& RoutingSearchParameters_PairInsertionStrategy_Name(RoutingSearchParameters_PairInsertionStrategy value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<RoutingSearchParameters_PairInsertionStrategy_descriptor,
                                                 0, 3>(
...
inline const std::string& RoutingSearchParameters_SchedulingSolver_Name(RoutingSearchParameters_SchedulingSolver value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<RoutingSearchParameters_SchedulingSolver_descriptor,
                                                 0, 2>(
      static_cast<int>(value));
}
...
class RoutingSearchParameters final :
 ...
 public:
  ...
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* PairInsertionStrategy_descriptor() {
  ...
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* SchedulingSolver_descriptor() {
  ...
  void set_allocated_log_tag(std::string* ptr);
...
inline PROTOBUF_ALWAYS_INLINE void RoutingSearchParameters::set_log_tag(Arg_&& arg,
                                                     Args_... args) {
  ;
  _impl_.log_tag_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void RoutingSearchParameters::set_allocated_log_tag(std::string* value) {
  _impl_.log_tag_.SetAllocated(value, GetArenaForAllocation());

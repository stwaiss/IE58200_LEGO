...
PROTOBUF_NAMESPACE_OPEN
template <>
::operations_research::ConstraintSolverParameters* Arena::CreateMaybeMessage<::operations_research::ConstraintSolverParameters>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
inline const std::string& ConstraintSolverParameters_TrailCompression_Name(ConstraintSolverParameters_TrailCompression value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<ConstraintSolverParameters_TrailCompression_descriptor,
                                                 0, 1>(
...
class ConstraintSolverParameters final :
 ...
 public:
  ...
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* TrailCompression_descriptor() {
  ...
  void set_allocated_profile_file(std::string* ptr);
...
inline PROTOBUF_ALWAYS_INLINE void ConstraintSolverParameters::set_profile_file(Arg_&& arg,
                                                     Args_... args) {
  ;
  _impl_.profile_file_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void ConstraintSolverParameters::set_allocated_profile_file(std::string* value) {
  _impl_.profile_file_.SetAllocated(value, GetArenaForAllocation());

...
PROTOBUF_NAMESPACE_OPEN
template <>
::operations_research::FirstSolutionStrategy* Arena::CreateMaybeMessage<::operations_research::FirstSolutionStrategy>(Arena*);
template <>
::operations_research::LocalSearchMetaheuristic* Arena::CreateMaybeMessage<::operations_research::LocalSearchMetaheuristic>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
inline const std::string& FirstSolutionStrategy_Value_Name(FirstSolutionStrategy_Value value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<FirstSolutionStrategy_Value_descriptor,
                                                 0, 16>(
...
inline const std::string& LocalSearchMetaheuristic_Value_Name(LocalSearchMetaheuristic_Value value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<LocalSearchMetaheuristic_Value_descriptor,
                                                 0, 6>(
      static_cast<int>(value));
}
...
class FirstSolutionStrategy final :
 ...
 public:
  ...
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Value_descriptor() {

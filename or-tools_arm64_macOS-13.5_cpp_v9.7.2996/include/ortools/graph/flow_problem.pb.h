...
PROTOBUF_NAMESPACE_OPEN
template <>
::operations_research::FlowArcProto* Arena::CreateMaybeMessage<::operations_research::FlowArcProto>(Arena*);
template <>
::operations_research::FlowModelProto* Arena::CreateMaybeMessage<::operations_research::FlowModelProto>(Arena*);
template <>
::operations_research::FlowNodeProto* Arena::CreateMaybeMessage<::operations_research::FlowNodeProto>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
inline const std::string& FlowModelProto_ProblemType_Name(FlowModelProto_ProblemType value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<FlowModelProto_ProblemType_descriptor,
                                                 0, 2>(
...
class FlowModelProto final :
 ...
 public:
  ...
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* ProblemType_descriptor() {
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::operations_research::FlowNodeProto>& _internal_nodes() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::operations_research::FlowNodeProto>* _internal_mutable_nodes();
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::operations_research::FlowArcProto>& _internal_arcs() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::operations_research::FlowArcProto>* _internal_mutable_arcs();
  public:
...
inline ::operations_research::FlowArcProto* FlowModelProto::_internal_add_arcs() {
  return _internal_mutable_arcs()->Add();
}
